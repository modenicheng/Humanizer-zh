...
> **原则：一次只读一个 reference 文件。** 如果跨多个层面，先处理最主要的问题，再考虑是否需读第二个。

### 第 3 步：应用模式处理

按 reference 文件中的模式逐项检查文本，替换 AI 痕迹。

### 第 4 步：自评（可选）

如果需要评分，读取 `references/scoring.md` 对改写结果打分。

---

## 通用准则（所有场景适用）

以下准则来自 `references/principles.md`，是每次处理都要遵守的底线：
